...
const LandingPage = () => {
  ...
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.3" className="  w-full h-screen bg-slate-900 pt-1">
      <div className="textstructure sm:mt-32 md:mt-52 sm: sm:px-5 md:px-20">
          ...
          (item, index) => {
            return (
              <div key={index} className="masker ">
               ...
               <h1 className=" h-full sm:text-5xl md:text-8xl tracking-tighter   leading-[7.5vw] font-semibold">
                  {item}
                </h1>
               </div>
              </div>
      ...
      <div className=" sm:px-5 border-t-2 border-zinc-500  mt-10 flex sm:flex-col md:flex-row gap-5  justify-between items-center md:px-20 py-5">
        {[
